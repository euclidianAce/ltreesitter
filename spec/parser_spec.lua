...
describe("Parser", function()
	...
	describe("language", function()
		it("should return an ltreesitter.Language", function()
			util.assert_userdata_type(p:language(), "ltreesitter.Language")
		end)
		it("should return the correct language", function()
			assert.are.equal(lang, p:language())
		end)
	end)
end)
