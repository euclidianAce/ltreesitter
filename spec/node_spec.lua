...
describe("Node", function()
	...
	describe("start_byte_offset", function()
		it("should return a number", function()
			assert.is.number(root[1]:start_byte_offset())
		end)
		it("should return the correct value", function()
			assert.are.equal(root[1]:start_byte_offset(), 1, "start_byte_offset is not the same")
		end)
	end)
	describe("end_byte_offset", function()
		it("should return a number", function()
			assert.is.number(root[1]:end_byte_offset())
		end)
		it("should return the correct value", function()
			assert.are.equal(root[1]:end_byte_offset(), 19, "end_byte_offset is not the same")
		end)
	end)

	describe("start_index", function()
		it("should return a number", function()
			assert.is.number(root[1]:start_index())
		end)
		it("should return the correct value", function()
			assert.are.equal(root[1]:start_index(), 2, "start_index is not the same")
		end)
	end)

	describe("end_index", function()
		it("should return a number", function()
			assert.is.number(root[1]:end_index())
		end)
		it("should return the correct value", function()
			assert.are.equal(root[1]:end_index(), 19, "end_index is not the same")
		end)
	end)
	...
	describe("language", function()
		it("should return a ltreesitter.Language", function()
			util.assert_userdata_type(root[1]:language(), "ltreesitter.Language")
		end)
		it("should return the correct language", function()
			assert.are.equal(root[1]:language(), c_lang)
		end)
	end)
end)
